...
#define CONFIG_ETHADDR	00:0a:35:00:92:e5
...
#define	CONFIG_SYS_PROMPT	"U-Boot-r2t2> "
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	PSSERIAL0 \
    "baudrate=115200\0" \                                                                 
    "bootargs=console=ttyPS0,115200 root=/dev/mmcblk0p2 rw rootfstype=ext4\0" \
	"nc=setenv stdout nc;setenv stdin nc;\0" \
	"sdboot=echo boot r2t2; mmcinfo && fatload mmc 0 ${netstart} ${kernel_img} && bootm \0" \
	"autoload=no\0" \
