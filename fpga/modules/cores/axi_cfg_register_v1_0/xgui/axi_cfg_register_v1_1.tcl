...
proc init_gui { IPINST } {
  ...
  set CFG_DATA_DEFAULT [ipgui::add_param $IPINST -name "CFG_DATA_DEFAULT" -parent ${Page_0}]
  set_property tooltip {Dault value as String} ${CFG_DATA_DEFAULT}
...
proc update_PARAM_VALUE.CFG_DATA_DEFAULT { PARAM_VALUE.CFG_DATA_DEFAULT } {
	# Procedure called to update CFG_DATA_DEFAULT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CFG_DATA_DEFAULT { PARAM_VALUE.CFG_DATA_DEFAULT } {
	# Procedure called to validate CFG_DATA_DEFAULT
	return true
}
...
proc update_MODELPARAM_VALUE.CFG_DATA_DEFAULT { MODELPARAM_VALUE.CFG_DATA_DEFAULT PARAM_VALUE.CFG_DATA_DEFAULT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CFG_DATA_DEFAULT}] ${MODELPARAM_VALUE.CFG_DATA_DEFAULT}
}
