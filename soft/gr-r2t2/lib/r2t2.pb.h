...
class R2T2Message_Gain : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:R2T2Proto.R2T2Message.Gain) */ {
 public:
  ...
  static const R2T2Message_Gain* internal_default_instance();

  void Swap(R2T2Message_Gain* other);

  // implements Message ----------------------------------------------

  inline R2T2Message_Gain* New() const { return New(NULL); }

  R2T2Message_Gain* New(::google::protobuf::Arena* arena) const;
  ...
  void UnsafeMergeFrom(const R2T2Message_Gain& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_r2t2_2eproto_impl();
  friend void  protobuf_AddDesc_r2t2_2eproto_impl();
  friend void protobuf_AssignDesc_r2t2_2eproto();
  friend void protobuf_ShutdownFile_r2t2_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<R2T2Message_Gain> R2T2Message_Gain_default_instance_;
...
class R2T2Message : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:R2T2Proto.R2T2Message) */ {
 public:
  ...
  static const R2T2Message* internal_default_instance();

  void Swap(R2T2Message* other);

  // implements Message ----------------------------------------------

  inline R2T2Message* New() const { return New(NULL); }

  R2T2Message* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const R2T2Message& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<R2T2Message> R2T2Message_default_instance_;
