...
const R2T2Message_Command R2T2Message_Command_Command_MIN = R2T2Message_Command_RXOPEN;
...
class R2T2Message_Gain : public ::google::protobuf::Message {
 public:
  R2T2Message_Gain();
  ...
  inline ::google::protobuf::uint32 adc() const;
  inline void set_adc(::google::protobuf::uint32 value);
 ...
 private:
  ...
  friend void  protobuf_AddDesc_r2t2_2eproto();
  friend void protobuf_AssignDesc_r2t2_2eproto();
  friend void protobuf_ShutdownFile_r2t2_2eproto();

  void InitAsDefaultInstance();
  static R2T2Message_Gain* default_instance_;
};
// -------------------------------------------------------------------

class R2T2Message : public ::google::protobuf::Message {
 public:
  R2T2Message();
  virtual ~R2T2Message();
  ...
  static const Command RXOPEN = R2T2Message_Command_RXOPEN;
  static const Command TXOPEN = R2T2Message_Command_TXOPEN;
  static const Command CLOSE = R2T2Message_Command_CLOSE;
  static const Command STARTAUDIO = R2T2Message_Command_STARTAUDIO;
  static const Command STOPAUDIO = R2T2Message_Command_STOPAUDIO;
  static const Command STARTFFT = R2T2Message_Command_STARTFFT;
  static const Command STOPFFT = R2T2Message_Command_STOPFFT;
  static const Command REQFFT = R2T2Message_Command_REQFFT;
  static const Command REINIT = R2T2Message_Command_REINIT;
  static const Command ACK = R2T2Message_Command_ACK;
  static const Command NACK = R2T2Message_Command_NACK;
  static const Command TIMEOUT = R2T2Message_Command_TIMEOUT;
  static const Command ALIVE = R2T2Message_Command_ALIVE;
  ...
  inline ::R2T2Proto::R2T2Message_Command command() const;
  inline void set_command(::R2T2Proto::R2T2Message_Command value);

  // optional bytes rxData = 2;
  inline bool has_rxdata() const;
  inline void clear_rxdata();
  static const int kRxDataFieldNumber = 2;
  inline const ::std::string& rxdata() const;
  inline void set_rxdata(const ::std::string& value);
  inline void set_rxdata(const char* value);
  inline void set_rxdata(const void* value, size_t size);
  inline ::std::string* mutable_rxdata();
  inline ::std::string* release_rxdata();
  inline void set_allocated_rxdata(::std::string* rxdata);

  // optional bytes txData = 3;
  inline bool has_txdata() const;
  inline void clear_txdata();
  static const int kTxDataFieldNumber = 3;
  inline const ::std::string& txdata() const;
  inline void set_txdata(const ::std::string& value);
  inline void set_txdata(const char* value);
  inline void set_txdata(const void* value, size_t size);
  inline ::std::string* mutable_txdata();
  inline ::std::string* release_txdata();
  inline void set_allocated_txdata(::std::string* txdata);

  // optional bytes fftData = 4;
  inline bool has_fftdata() const;
  inline void clear_fftdata();
  static const int kFftDataFieldNumber = 4;
  inline const ::std::string& fftdata() const;
  inline void set_fftdata(const ::std::string& value);
  inline void set_fftdata(const char* value);
  inline void set_fftdata(const void* value, size_t size);
  inline ::std::string* mutable_fftdata();
  inline ::std::string* release_fftdata();
  inline void set_allocated_fftdata(::std::string* fftdata);

  // optional uint32 txDataAck = 10;
  inline bool has_txdataack() const;
  inline void clear_txdataack();
  static const int kTxDataAckFieldNumber = 10;
  inline ::google::protobuf::uint32 txdataack() const;
  inline void set_txdataack(::google::protobuf::uint32 value);
  ...
  inline bool has_txrate() const;
  inline void clear_txrate();
  static const int kTxRateFieldNumber = 22;
  inline ::google::protobuf::uint32 txrate() const;
  inline void set_txrate(::google::protobuf::uint32 value);

  // optional uint32 rxRate = 23;
  inline bool has_rxrate() const;
  inline void clear_rxrate();
  static const int kRxRateFieldNumber = 23;
  inline ::google::protobuf::uint32 rxrate() const;
  inline void set_rxrate(::google::protobuf::uint32 value);

  // optional uint32 fftRate = 24;
  inline bool has_fftrate() const;
  inline void clear_fftrate();
  static const int kFftRateFieldNumber = 24;
  inline ::google::protobuf::uint32 fftrate() const;
  inline void set_fftrate(::google::protobuf::uint32 value);
  ...
  inline const ::R2T2Proto::R2T2Message_Gain& gain() const;
  inline ::R2T2Proto::R2T2Message_Gain* mutable_gain();
  inline ::R2T2Proto::R2T2Message_Gain* release_gain();
  inline void set_allocated_gain(::R2T2Proto::R2T2Message_Gain* gain);
  ...
  inline const ::R2T2Proto::R2T2Message_Gain& att() const;
  inline ::R2T2Proto::R2T2Message_Gain* mutable_att();
  inline ::R2T2Proto::R2T2Message_Gain* release_att();
  inline void set_allocated_att(::R2T2Proto::R2T2Message_Gain* att);

  // optional uint32 antenna = 42;
  inline bool has_antenna() const;
  inline void clear_antenna();
  static const int kAntennaFieldNumber = 42;
  inline ::google::protobuf::uint32 antenna() const;
  inline void set_antenna(::google::protobuf::uint32 value);

  // optional double forwardPower = 50;
  inline bool has_forwardpower() const;
  inline void clear_forwardpower();
  static const int kForwardPowerFieldNumber = 50;
  inline double forwardpower() const;
  inline void set_forwardpower(double value);

  // optional double backwardPower = 51;
  inline bool has_backwardpower() const;
  inline void clear_backwardpower();
  static const int kBackwardPowerFieldNumber = 51;
  inline double backwardpower() const;
  inline void set_backwardpower(double value);

  // @@protoc_insertion_point(class_scope:R2T2Proto.R2T2Message)
 private:
  inline void set_has_command();
  inline void clear_has_command();
  inline void set_has_rxdata();
  inline void clear_has_rxdata();
  inline void set_has_txdata();
  inline void clear_has_txdata();
  inline void set_has_fftdata();
  inline void clear_has_fftdata();
  inline void set_has_txdataack();
  inline void clear_has_txdataack();
  inline void set_has_rxfreq();
  inline void clear_has_rxfreq();
  inline void set_has_txfreq();
  inline void clear_has_txfreq();
  inline void set_has_txrate();
  inline void clear_has_txrate();
  inline void set_has_rxrate();
  inline void clear_has_rxrate();
  inline void set_has_fftrate();
  inline void clear_has_fftrate();
  ...
  inline void set_has_forwardpower();
  inline void clear_has_forwardpower();
  inline void set_has_backwardpower();
  inline void clear_has_backwardpower();
  ...
  void InitAsDefaultInstance();
  static R2T2Message* default_instance_;
};
// ===================================================================
...
inline void R2T2Message::set_rxdata(const ::std::string& value) {
  set_has_rxdata();
  if (rxdata_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    rxdata_ = new ::std::string;
  }
  rxdata_->assign(value);
...
inline void R2T2Message::set_rxdata(const void* value, size_t size) {
  ...
  rxdata_->assign(reinterpret_cast<const char*>(value), size);
...
inline void R2T2Message::set_txdata(const ::std::string& value) {
  set_has_txdata();
  if (txdata_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    txdata_ = new ::std::string;
  }
  txdata_->assign(value);
...
inline void R2T2Message::set_txdata(const void* value, size_t size) {
  ...
  txdata_->assign(reinterpret_cast<const char*>(value), size);
...
inline void R2T2Message::set_fftdata(const ::std::string& value) {
  set_has_fftdata();
  if (fftdata_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    fftdata_ = new ::std::string;
  }
  fftdata_->assign(value);
...
inline void R2T2Message::set_fftdata(const void* value, size_t size) {
  ...
  fftdata_->assign(reinterpret_cast<const char*>(value), size);
...
inline const ::R2T2Proto::R2T2Message_Gain& R2T2Message::gain() const {
  ...
  return gain_ != NULL ? *gain_ : *default_instance_->gain_;
}
inline ::R2T2Proto::R2T2Message_Gain* R2T2Message::mutable_gain() {
  set_has_gain();
  if (gain_ == NULL) gain_ = new ::R2T2Proto::R2T2Message_Gain;
...
inline ::R2T2Proto::R2T2Message_Gain* R2T2Message::mutable_att() {
  set_has_att();
  if (att_ == NULL) att_ = new ::R2T2Proto::R2T2Message_Gain;
