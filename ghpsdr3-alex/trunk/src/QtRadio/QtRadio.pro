...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/win32libs/ -lcodec2 -lsamplerate -lortp
else:win32:CONFIG(debug, debug|release):  LIBS += -L$$PWD/win32libs/ -lcodec2 -lsamplerate -lortp
